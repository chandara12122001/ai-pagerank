...
def sample_pagerank(corpus, damping_factor, n):
    ...
    All PageRank values should sum to 1.
    """
    ...
    for i in range(0, n-1):
        ...
        # Pick next page randomly based on the transition model probability:
        # which means selecting page randomly by its weight
...
def iterate_pagerank(corpus, damping_factor):
    ...
    # initial values - cos we dont know the page rank at first iteration
    ...
    while max_rank_change > 0.001:
        ...
        for page_name in corpus:
            ...
            for other_page in corpus:
                ...
                # which is 1 / number of pages within corpus
        ...
        # Normalise the new page ranks, to ensure that the sum is 1
